  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="container mx-auto py-8 px-4 max-w-3xl">
        {/*header*/}
      <div className="mb-6">
        <Link href="/thesis" className="text-[#011638] hover:text-[#141414] inline-block mb-2">
          ← Back
        </Link>
            ...
            <div>
              ...
              <div style={{ borderColor: '#011638' }} className="border-2 border-t-2 rounded-b-md p-4">
                ...
                <div>
                  ...
                  <label htmlFor="digital" className="block text-sm font-medium text-gray-700 mb-1">
                  Digital Copy Link
                  </label>
