            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-[#e0e7ff]">
              {!showRejectForm ? (
                <>
                  ...
                  <button onClick={handleApprove} disabled={isSubmitting} className="px-4 py-2 text-[#fbfaf8] bg-[#1e4db7] border border-[#1e4db7] rounded-lg hover:bg-[#1a2a4f] transition-colors font-oswald disabled:opacity-50 disabled:cursor-not-allowed">Approve Thesis</button>
                </>
              ) : (
                <>
                  <button onClick={() => {
