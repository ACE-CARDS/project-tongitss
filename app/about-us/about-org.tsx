    ...
    <section id="about-org" className="relative flex flex-col pt-0 pb-20 px-6 lg:px-20 z-10">
      <div className="max-w-6xl mx-auto w-full flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="w-full max-w-5xl h-[30vh] lg:h-[45vh] shadow-2xl overflow-hidden rounded-[2.5rem] border-[6px] border-white relative z-20"
        >
          <img  
        ...
        >
          <div className="bg-white/95 backdrop-blur-2xl border border-white rounded-[2.5rem] shadow-2xl p-10 lg:p-16 flex flex-col lg:flex-row gap-12 items-stretch">
            ...
            <div className="w-full lg:w-[45%] bg-gradient-to-br from-[#fefce8] to-white rounded-[2rem] p-10 lg:p-12 border border-[#fde047] shadow-lg relative overflow-hidden transition-transform duration-300 hover:scale-[1.02] flex flex-col justify-center">
