  ...
  return (
    <div className="w-full flex flex-col -mt-6 md:-mt-8">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full max-w-7xl mx-auto mb-10 px-4">
        ...
        <div id="top" className="target-section flex flex-wrap items-center justify-center md:justify-end gap-3 w-full md:w-auto shrink-0">
        ...
        <div className="relative w-full max-w-6xl mx-auto mb-14 px-4 sm:px-12 group">
          {canScrollLeft && (
            <button 
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 z-4 w-8 h-8 flex items-center justify-center bg-white rounded-full shadow border border-slate-200 text-[#011638] hover:bg-slate-50 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
            >
          ...
          {canScrollRight && (
            <button 
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-4 w-8 h-8 flex items-center justify-center bg-white rounded-full shadow border border-slate-200 text-[#011638] hover:bg-slate-50 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
            >
            ...
            <div className="flex justify-between items-center w-full min-w-max px-4">
              {["ALL", ...availableYears].map((year) => (
                <div
                  ...
                  className="relative z-4 flex flex-col items-center cursor-pointer group flex-1 min-w-[80px] md:min-w-[120px] shrink-0"
                >
                  <span
