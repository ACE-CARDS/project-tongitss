...
//main page
export default function SurveyHeader({ initialQuery = "" }: SurveyHeaderProps) {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setQuery(value);
    router.replace(`/survey${value ? `?query=${encodeURIComponent(value)}` : ""}`);
  };

  return (
    <div className="mb-8"> {/* Just a simple margin bottom */}
        ...
        <div className="flex-1">
          <div className="relative">
            <input
              ...
              value={query}
              onChange={handleChange} // You forgot to attach this!
