              ...
              {!showRejectForm ? (
                <>
                  <button
                    ...
                    className="px-6 py-2 text-red-600 border border-red-600 rounded hover:bg-red-50 transition-colors font-oswald font-bold"
                  >
                    REJECT
                  </button>
                  <button
                    onClick={handleApprove}
                    className="px-6 py-2 text-[#fbfaf8] bg-green-600 rounded hover:bg-green-700 transition-colors font-oswald font-bold shadow-md"
                  >
                    APPROVE SURVEY
                  </button>
                </>
