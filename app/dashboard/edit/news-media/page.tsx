...
function EditNewsMediaContent() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#fbfaf8] overflow-y-auto" style={{ backgroundImage: 'radial-gradient(#cbd5e1 1px, transparent 1px)', backgroundSize: "20px 20px" }}>
      <NavBar/>
      <div className="pt-5">
        <main className="container mx-auto py-8 px-4 max-w-3xl">
          <div className="mb-6">
            <button
              onClick={() => from === 'admin' ? router.push('/dashboard?tab=manage&section=news') : router.back()}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="border-2 border-t-2 border-[#011638] rounded-b-md p-4 space-y-4">
                  <div>
                    <label className="block text-sm font-oswald font-medium text-[#011638] mb-1">Title</label>
                    <input
                      type="text"
                      name="title"
                      ...
                      <div className="space-y-1 text-center">
                        {imagePreview ? (
                          ...
                          <div className="text-sm text-[#475569]">
                            <p className="font-medium text-[#011638]">Click to upload</p>
                ...
                <div className="border-2 border-t-2 border-[#011638] rounded-b-md p-4 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="text-[#475569] font-ubuntu-mono w-full px-3 py-2 border border-[#94a3b8] rounded focus:outline-none focus:border-[#011638] bg-[#fbfaf8]"
                    />
                    {postUrlError && <span className="text-xs text-red-600 font-ubuntu-mono">{postUrlError}</span>}
                  </div>
