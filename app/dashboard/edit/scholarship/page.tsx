...
function EditScholarshipContent() {
    ...
    if (user?.role !== "admin" && user?.role !== "superadmin") {
        return (
            <div className="flex items-center justify-center min-h-screen">
                <p className="font-ubuntu-mono text-[#475569]">You are not authorized to edit scholarship entries.</p>
            </div>
        );
    }
        ...
        try {
            if (type === "school") {
                ...
                if (data) {
                    const fetchedData = {
                        school: data.school || "",
                        school_acronym: data.school_acronym || "",
    ...
    const validateForm = () => {
        if (type === "school") {
            ...
            const hasAnyChange = schoolData.school !== initialSchoolData.school ||
                                schoolData.school_acronym !== initialSchoolData.school_acronym ||
                                schoolData.province !== initialSchoolData.province ||
                                schoolData.courses !== initialSchoolData.courses
            ...
            // Check if changed field has value
            let changedFieldHasValue = true;
            if (schoolData.school !== initialSchoolData.school && schoolData.school.trim().length === 0) {
                changedFieldHasValue = false;
            }
            if (schoolData.school_acronym !== initialSchoolData.school_acronym && schoolData.school_acronym.trim().length === 0) {
                changedFieldHasValue = false;
            }
            if (schoolData.province !== initialSchoolData.province && schoolData.province.trim().length === 0) {
                changedFieldHasValue = false;
            }
            if (schoolData.courses !== initialSchoolData.courses && schoolData.courses.trim().length === 0) {
                changedFieldHasValue = false;
            }

            setIsFormValid(hasAnyChange && !hasVisibleError && changedFieldHasValue);
        } else {
            // Check if field has changed
            const hasAnyChange = faqData.question !== initialFaqData.question ||
                                faqData.answer !== initialFaqData.answer;
            ...
            // Check if changed field has value
            let changedFieldHasValue = true;
            if (faqData.question !== initialFaqData.question && faqData.question.trim().length === 0) {
                changedFieldHasValue = false;
            }
            if (faqData.answer !== initialFaqData.answer && faqData.answer.trim().length === 0) {
                changedFieldHasValue = false;
            }
    ...
    const handleSchoolSubmit = async (e: React.FormEvent) => {
        ...
        if (!hasAnyChange) {
            setSubmitError("No changes made to update.");
            return;
        }
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onInput={(e) => {
                                                    ...
                                                    if (input.value.length === 0 && input.value !== initialSchoolData.school) {
                                                        errorSpan!.textContent = 'School name is required.';
                                                        errorSpan!.style.display = 'block';
                                                    } else if (input.value.length < 2 && input.value.length > 0) {
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onInput={(e) => {
                                                    ...
                                                    if (input.value.length === 0 && input.value !== initialSchoolData.school_acronym) {
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onInput={(e) => {
                                                    ...
                                                    if (input.value.length === 0 && input.value !== initialSchoolData.province) {
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                onInput={(e) => {
                                                    ...
                                                    if (input.value.length === 0 && input.value !== initialSchoolData.courses) {
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onInput={(e) => {
                                                    ...
                                                    if (input.value.length === 0 && input.value !== initialFaqData.question) {
                                                        errorSpan!.textContent = 'Question is required.';
                                                        errorSpan!.style.display = 'block';
                                                    } else if (input.value.length < 5 && input.value.length > 0) {
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                onInput={(e) => {
                                                    ...
                                                    if (input.value.length === 0 && input.value !== initialFaqData.answer) {
