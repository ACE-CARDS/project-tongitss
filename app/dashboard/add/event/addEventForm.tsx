            ...
            <div className="border-2 border-t-2 border-[#011638] rounded-b-md p-4 space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {/* NEW PREVIEW BLOCK */}
                  {previewUrl && (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-3 bg-white rounded border border-[#94a3b8]">
                      <div 
                        className="relative cursor-pointer group rounded overflow-hidden border border-[#94a3b8]"
                        onClick={() => setIsFullscreen(true)}
                        title="Click to enlarge"
                      >
                        <img src={previewUrl} alt="Preview" className="h-20 w-24 object-cover group-hover:opacity-75 transition-opacity" />
                      ...
                      <button 
                        type="button" 
                        onClick={clearImage}
                        className="text-xs bg-red-100 text-red-700 font-bold px-4 py-2 rounded hover:bg-red-600 hover:text-white transition-colors border border-red-200 shadow-sm"
                      >
                        ✕ Remove Image
                      </button>
                    </div>
