...
export default function ManagePage() {
  ...
  useEffect(() => {
    ...
    if (
      section &&
      ["announcements", "news", "events", "memapp"].includes(section)
    ) {
  ...
  if (activeSection) {
    const currentOption = manageOptions.find(
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-start gap-4">
                      ...
                      <h3 className="text-xl font-bold text-white my-auto text-left leading-tight">
                        {option.label}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <p className="text-gray-600 text-sm mb-5 text-left leading-relaxed">
                      {option.description}
                    </p>
