  ...
  if (loading)
    return (
      <div className="text-center py-12">
        <p className="text-gray-500 font-ubuntu-mono">Loading events...</p>
      </div>
    );
              ...
              <table className="w-full table-fixed">
                <thead className="bg-[#011638]">
                  <tr>
                    ...
                    <th
                      className={`px-4 py-3 text-center text-xs font-oswald font-bold text-[#eff0f2] uppercase tracking-wider cursor-pointer hover:bg-[#0d21a1] transition-colors w-[220px] ${sortField === "start_date" ? "bg-[#0d21a1]" : ""}`}
                ...
                <tbody className="divide-y divide-gray-200">
                  {currentEvents.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-center">
                        <div className="text-sm font-bold text-[#011638] font-ubuntu-mono mb-1">
                      ...
                      <td className="px-4 py-4 text-center">
                        <div className="flex justify-center gap-2">
                          <button
                            onClick={() =>
                              router.push(`/dashboard/edit/event/${item.id}`)
                            }
