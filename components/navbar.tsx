    ...
    <div className="sticky top-0 z-50">
      ...
      <nav className="relative w-full mx-auto my-auto max-w-[1400px] top-3 h-16">
        <div className="flex flex-row items-center justify-between lg:px-8 px-2 w-full h-full lg:gap-4 gap-2 text-white ">
          ...
          <a
            className="shadow-[0_5px_10px_#011638]/80 flex flex-row items-center h-full w-fit gap-2 rounded-[50px] px-4 pr-6 bg-[#011638]/70 border-[#011638]/35 border-3 backdrop-blur-sm hover:bg-[#011638]/80 transition-all duration-200 hover:scale-[1.04]"
            href="/"
          >
            <Image
              ...
              {!user ? (
                <>
                  <Link href="/member-appli">
                    <li
                      className={`w-[140px] py-[8px] rounded-[50px] border-white/50 border-2 duration-200 transition-all ease-in-out bg-white/80 text-center text-black backdrop-blur-xs
                        ${
